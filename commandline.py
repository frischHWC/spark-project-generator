...
def command_line_arguments_to_dict():
    ...
    # Required arguments
    parser.add_argument('--version', required=True, type=str, choices=["2.4.0.7.1.1.0-565", "2.4.0.7.1.2.0-96", "2.4.1", "2.4.7.7.1.7.0-551",  "2.4.0.7.1.6.0-297",  "2.4.0.7.1.5.0-257",  "2.4.0.7.1.4.0-203",  "2.4.0.7.1.3.0-100",  "2.2.0", "2.3.0", "2.3.1", "2.3.2", "2.3.3"],
